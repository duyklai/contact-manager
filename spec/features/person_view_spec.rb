...
describe 'Email Address' do
  describe 'the person view', type: :feature do
    let(:person) { Person.create(first_name: 'Robert', last_name: 'Lee') }

    before(:each) do
      person.email_addresses.create(address: 'rlee@example.com')
      person.email_addresses.create(address: 'robertKLee@gmail.com')
      visit person_path(person)
    end
